...
builder.Services.AddSingleton<PdfStatementExtractor>();
...
using (var scope = app.Services.CreateScope())
{
    ...
    await EnsureWhatsAppSchemaAsync(financeDb);
}
...
static async Task EnsureWhatsAppSchemaAsync(FinanceDbContext context)
{
    var senderSql = context.Database.IsNpgsql()
        ? """
          CREATE TABLE IF NOT EXISTS "WhatsAppSenders" (
          ...
          CREATE UNIQUE INDEX IF NOT EXISTS "IX_WhatsAppSenders_PhoneNumber" ON "WhatsAppSenders" ("PhoneNumber");
          """
        : """
          CREATE TABLE IF NOT EXISTS "WhatsAppSenders" (
          ...
          CREATE UNIQUE INDEX IF NOT EXISTS "IX_WhatsAppSenders_PhoneNumber" ON "WhatsAppSenders" ("PhoneNumber");
          """;
    var inboxSql = context.Database.IsNpgsql()
        ? """
          CREATE TABLE IF NOT EXISTS "WhatsAppInboxItems" (
              "Id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
              ...
              "Body" text NOT NULL,
              "SuggestedAmount" numeric NULL,
              "SuggestedDescription" text NOT NULL,
              "SuggestedType" integer NOT NULL,
              "SuggestedPaymentMethodId" integer NULL,
              "SuggestedIsFixed" boolean NOT NULL,
              "SuggestedInstallmentCurrent" integer NULL,
              "SuggestedInstallmentTotal" integer NULL,
              "Status" integer NOT NULL,
              "ProcessedAt" timestamp with time zone NULL,
              "TransactionId" integer NULL
          );
          CREATE UNIQUE INDEX IF NOT EXISTS "IX_WhatsAppInboxItems_ProviderMessageId" ON "WhatsAppInboxItems" ("ProviderMessageId");
          """
        : """
          CREATE TABLE IF NOT EXISTS "WhatsAppInboxItems" (
              "Id" INTEGER PRIMARY KEY AUTOINCREMENT,
              ...
              "Body" TEXT NOT NULL,
              "SuggestedAmount" TEXT NULL,
              "SuggestedDescription" TEXT NOT NULL,
              "SuggestedType" INTEGER NOT NULL,
              "SuggestedPaymentMethodId" INTEGER NULL,
              "SuggestedIsFixed" INTEGER NOT NULL,
              "SuggestedInstallmentCurrent" INTEGER NULL,
              "SuggestedInstallmentTotal" INTEGER NULL,
              "Status" INTEGER NOT NULL,
          ...
          CREATE UNIQUE INDEX IF NOT EXISTS "IX_WhatsAppInboxItems_ProviderMessageId" ON "WhatsAppInboxItems" ("ProviderMessageId");
          """;
    await context.Database.ExecuteSqlRawAsync(senderSql);
    await context.Database.ExecuteSqlRawAsync(inboxSql);
}
